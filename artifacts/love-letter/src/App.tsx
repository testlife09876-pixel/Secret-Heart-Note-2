...
const loveLetter = `میری جان،

کچھ احساسات ایسے ہوتے ہیں جنہیں لفظوں میں بیان کرنا آسان نہیں ہوتا، اور آپ میرے لیے بھی ایک ایسا ہی خوبصورت احساس ہیں۔ جب سے آپ میری زندگی میں آئی ہیں، جیسے ہر چیز میں ایک الگ سی خوبصورتی اور خوشی آ گئی ہے۔

مجھے نہیں معلوم کہ میں اپنی محبت کا احساس آپ کو کتنی اچھی طرح سمجھا پاتا ہوں، لیکن اتنا ضرور جانتا ہوں کہ آپ کی مسکراہٹ میرے لیے بہت خاص ہے، آپ کی خوشی میرے لیے بہت معنی رکھتی ہے، اور آپ کا ساتھ میری سب سے خوبصورت خواہش ہے۔

میں آپ سے صرف محبت نہیں کرتا، بلکہ آپ کو دل کی گہرائیوں سے چاہتا ہوں۔ میری ہمیشہ یہی دعا ہے کہ ہمارا یہ خوبصورت رشتہ اسی طرح قائم رہے اور ہمارے درمیان محبت ہمیشہ بڑھتی رہے۔

آپ میری زندگی کا وہ خوبصورت حصہ ہیں، جسے میں کبھی کھونا نہیں چاہتا۔ ❤️`;
